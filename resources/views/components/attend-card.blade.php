  ...
  <div class="card-body py-3">
      <div class="d-flex flex-column w-100 justify-content-between">
          <div class="flex-row">
              ...
              <span class="mx-1 small">{{$attend->data_inicial->translatedFormat('l \, j \d\e F \à\s H:i A')}}</span>
              <div>
    ...
    <div class="card-footer py-1 d-flex my-1 justify-content-between items-center">
        ...
        <div class="btn-group my-2">
            ...
            <button class="btn-sm btn-outline-{{$statusColor}}" data-toggle="modal" data-target="#schedulle-modal{{$attend->id}}">
                <i class="fas fa-calendar-week"></i> Agendamento
            </button>
