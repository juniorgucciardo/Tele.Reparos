<div class="modal fade" id="exampleModal{{$solicited->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="card card-info card-outline">
          <div class="modal-body">
            ...
            <form action="{{ route('accept.OS', $solicited->id)}}" method="POST">
              @method('PUT')
              @csrf
             ...
             <div class="row">
              <div class="form-group col-12 col-md-6">
                ...
                <input type="date" name="data_ordem" class="form-control" id="recipient-name" value="{{$solicited}}">
              </div>
              <div class="form-group col-12 col-md-6">
                <label for="message-text" class="col-form-label">Hora:</label>
                <input type="time" name="hora_ordem" class="form-control" id="recipient-name" value="{{$solicited}}">
              </div>
             </div>
